/*charArray isimli dizi deðiþkenini dikkate alarak karakter uzunluðu kullanýcý tarafýndan
girilen bir kelimeden kaç tane olduðunu bulacak uygulamayý yaziniz*/
...
int main(void)
{
	...
	printf("Enter a character length:\n");
	scanf("%d", &number);
	...
	printf("There are %d words with the character length you entered.\n", counter2);
